...
class DatabaseHadithGradeConverterTest {
    ...
    @DisplayName("Round-trip conversion of DatabaseHadithGrade enum should be consistent")
    void roundTripConversion_validEnum_preservesValue(DatabaseHadithGrade originalGrade) {
        String dbValue = converter.convertToDatabaseColumn(originalGrade);
        DatabaseHadithGrade convertedGrade = converter.convertToEntityAttribute(dbValue);
    ...
    @Test
    @DisplayName("Should return null when converting null DatabaseHadithGrade to DB column")
    void convertToDatabaseColumn_nullEnum_returnsNull() {
        String result = converter.convertToDatabaseColumn(null);
        assertNull(result, "Expected result to be null when converting null DatabaseHadithGrade");
    }

    @Test
    @DisplayName("Should return null when converting null DB string to DatabaseHadithGrade enum")
