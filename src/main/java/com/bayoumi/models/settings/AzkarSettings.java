...
import static com.bayoumi.util.gui.notfication.NotificationAudio.SILENT_NOTIFICATION;
...
public class AzkarSettings {
    ...
    public int getMorningAzkarOffset() {
        // TODO: Check there's most likely a bug here because it returns the same
        // value as getMorningAzkarReminder
        return morningAzkarReminder;
    }

    public int getNightAzkarOffset() {
        // TODO: Check there's most likely a bug here because it returns the same
        // value as getNightAzkarReminder
    ...
    public String getAudioName() {
        return NotificationAudio.getAudios().stream()
                .filter(audio -> audio.getFileName().equals(audioName))
                .findFirst()
                .orElse(SILENT_NOTIFICATION)
                .getFileName();
    }
